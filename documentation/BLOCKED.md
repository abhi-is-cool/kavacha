...
| # | Item | Why it is blocked | What unblocks it |
|---|---|---|---|
| ~~**B4**~~ | ~~**Windows native build**~~ | ✅ **RESOLVED 2026-09-22.** CI publishes a Windows installer to the `nightly` release on a green three-platform scheduled run ([VERIFICATION](VERIFICATION.md) §4k). Never a decision — ordinary work, and in the end a 260-character path limit. | Nothing. Closed. |
