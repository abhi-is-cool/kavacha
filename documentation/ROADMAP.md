...
## Phase 7 — Browser, later (post-v1.0) — **built + L4-verified 2026-08-27; re-verified on the Firefox ESR base 2026-09-20**

> First built and driven at runtime on the **Zen** base on 2026-08-27:
> `marionette-phase7.py`, 75/75 ([VERIFICATION](VERIFICATION.md) §4d). That first run found
